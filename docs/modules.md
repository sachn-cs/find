...
The `find` crate is organized into six modules with clear responsibility boundaries. This document provides a module-by-module reference and complements the rustdoc generated by `cargo doc`.
